...
public class CacheUtil {
    ...
    private static RedisTemplate<String, Object> redisTemplate = (RedisTemplate)CacheContextUtil.getBean("redisTemplate");

    private static StringRedisTemplate stringRedisTemplate = (StringRedisTemplate)CacheContextUtil.getBean("stringRedisTemplate");
